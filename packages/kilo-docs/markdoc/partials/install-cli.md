Use TakeDeep directly from your terminal for maximum flexibility.
...
1. Go to [Kilo Releases](https://github.com/Quantum-General-Intelligence/Deepcode-vscode/releases)
