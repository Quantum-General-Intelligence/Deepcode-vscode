TakeDeep supports all JetBrains IDEs including IntelliJ IDEA, WebStorm, PyCharm, and more.

### Prerequisites

Before installing the TakeDeep plugin, ensure you have:
...
2. Then, you can click the button below to install TakeDeep directly from the JetBrains Marketplace:

[![Install TakeDeep](https://raster.shields.io/badge/Install%20Kilo%20Code-F8F674?style=for-the-badge)](https://plugins.jetbrains.com/plugin/28350-kilo-code)
