...
description: "How to capture console logs and report issues with TakeDeep"
---
...
1. Make sure the **TakeDeep panel is open** in your IDE (the debug target won't appear unless the webview is active)
...
4. Find the entry with `"title": "TakeDeep"` and open the `devtoolsFrontendUrl` link
