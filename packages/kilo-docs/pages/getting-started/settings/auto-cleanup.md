...
As you work with TakeDeep, each task creates files containing conversation history, checkpoints, and other data. Over time, this accumulates and can consume significant disk space. Auto-Cleanup solves this by:
...
Access Auto-Cleanup settings through the TakeDeep settings panel:
...
- **macOS**: `~/Library/Application Support/Code/User/globalStorage/takedeep.takedeep/`
- **Windows**: `%APPDATA%\Code\User\globalStorage\takedeep.takedeep\`
- **Linux**: `~/.config/Code/User/globalStorage/takedeep.takedeep/`
