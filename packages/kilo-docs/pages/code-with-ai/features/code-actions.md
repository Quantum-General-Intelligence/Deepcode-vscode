---
title: "Code Actions"
description: "Quick code actions and refactoring with TakeDeep"
---

# Code Actions

Code Actions are a powerful feature of VS Code that provide quick fixes, refactorings, and other code-related suggestions directly within the editor. TakeDeep integrates with this system to offer AI-powered assistance for common coding tasks.
...
Clicking the lightbulb, right-clicking and selecting "TakeDeep", or using the keyboard shortcut (`Ctrl+.` or `Cmd+.` on macOS, by default), displays a menu of available actions.

{% image src="/docs/img/code-actions/code-actions-1.png" alt="VS Code code actions in line with code" width="500" /%}

## TakeDeep's Code Actions

TakeDeep provides the following Code Actions:
...
- **Explain Code:** Asks TakeDeep to explain the selected code.
- **Fix Code:** Asks TakeDeep to fix problems in the selected code (available when diagnostics are present).
- **Improve Code:** Asks TakeDeep to suggest improvements to the selected code.

### Add to Context Deep Dive

The **Add to Context** action is listed first in the Code Actions menu so you can quickly add code snippets to your conversation. When you use it, TakeDeep includes the filename and line numbers along with the code.
...
There are three main ways to use TakeDeep's Code Actions:
...
4.  **Choose an Action:** Select the desired TakeDeep action from the menu.
5.  **Review and Approve:** TakeDeep will propose a solution in the chat panel. Review the proposed changes and approve or reject them.
...
3.  **Choose "TakeDeep":** Select the "TakeDeep" option from the context menu. A submenu will appear with the available TakeDeep actions.
...
3.  **Type a Command:** Type "TakeDeep" to filter the commands, then choose the relevant code action (e.g., "TakeDeep: Explain Code"). You can also type the start of the command, like "TakeDeep: Explain", and select from the filtered list.
4.  **Review and Approve:** TakeDeep will propose a solution in the chat panel. Review the proposed changes and approve or reject them.
...
1.  **Open the Prompts Tab:** Click the {% codicon name="notebook" /%} icon in the TakeDeep top menu bar.
...
By using TakeDeep's Code Actions, you can quickly get AI-powered assistance directly within your coding workflow. This can save you time and help you write better code.
