---
title: "Code with AI"
description: "Learn how to code with AI using TakeDeep across different platforms and interfaces"
---

# {% $markdoc.frontmatter.title %}

{% callout type="generic" %}
TakeDeep is your AI pair programmer that works in your IDE, terminal, or browser. Generate code, refactor, debug, and ship faster with AI that understands your codebase and context.
{% /callout %}

## Getting Started

New to TakeDeep? Start here to understand the core concepts:

- [**Install TakeDeep**](/docs/getting-started/installing) — Get started in VS Code, JetBrains, CLI, or mobile
...
Use TakeDeep wherever you work:
