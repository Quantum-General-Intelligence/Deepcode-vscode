...
Codebase Indexing enables semantic code search across your entire project using AI embeddings. Instead of searching for exact text matches, it understands the _meaning_ of your queries, helping TakeDeep find relevant code even when you don't know specific function names or file locations.
...
4. **Provides the [`semantic_search`](/docs/automate/tools/semantic-search) tool** to TakeDeep for intelligent code discovery
...
- **Enhanced AI Understanding**: TakeDeep can better comprehend and work with your codebase
...
3. If you don't see the icon, open TakeDeep settings (<Codicon name="gear" />) and search for **Codebase Indexing**
...
Once indexed, TakeDeep can use the [`semantic_search`](/docs/automate/tools/semantic-search) tool to find relevant code:
...
The tool provides TakeDeep with:
