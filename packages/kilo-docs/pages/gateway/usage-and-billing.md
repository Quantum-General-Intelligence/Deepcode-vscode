...
Your account balance is the difference between total credits purchased and total usage. Check your balance in the [Kilo dashboard](https://deeper-dash.takedeep.ai).
...
```json
{
  "error": {
    ...
    "code": 402,
    "metadata": {
      "buyCreditsUrl": "https://deeper-dash.takedeep.ai/credits"
    }
  }
}
```
