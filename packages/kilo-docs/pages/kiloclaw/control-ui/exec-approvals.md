...
description: "Control which commands your TakeDeep Claw agent can run on the host machine"
---
...
If you want to skip per-command approvals entirely, you can set the security policy to **Allow Everything** directly from the [TakeDeep Claw Settings dashboard](https://deeper-dash.takedeep.ai/claw/settings). This applies the `full` policy globally, allowing your agent to execute any host command without prompts — equivalent to elevated mode.
...
{% image src="/docs/img/kiloclaw/allow-everything-settings.png" alt="Allow Everything setting in TakeDeep Claw Settings Dashboard" width="800" caption="The Allow Everything toggle in TakeDeep Claw Settings" /%}
