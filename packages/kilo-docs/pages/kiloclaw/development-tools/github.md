...
description: "Connect a GitHub account to your TakeDeep Claw agent for repository access"
---

# GitHub Integration

Connect a GitHub account to your TakeDeep Claw agent so it can clone repositories, push commits, open pull requests, and leave code reviews — all autonomously.
...
TakeDeep Claw uses a [fine grained Personal Access Token](https://github.com/settings/tokens?type=beta) to authenticate as your bot. When creating the token, use these settings:
...
### Step 3: Enter credentials in TakeDeep Claw
...
TakeDeep Claw accepts both GitHub token formats:
...
When your instance starts, TakeDeep Claw automatically:
...
- Tokens are encrypted at rest using TakeDeep Claw's secret management system
