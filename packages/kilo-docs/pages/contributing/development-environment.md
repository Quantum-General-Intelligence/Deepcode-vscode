...
{% callout type="info" %}
**New versions of the VS Code extension and CLI are being developed in [Quantum-General-Intelligence/Deepcode-vscode](https://github.com/Quantum-General-Intelligence/Deepcode-vscode)** (extension at `packages/kilo-vscode`, CLI at `packages/opencode`). For extension and CLI development, please head over to that repository.
{% /callout %}
...
1. **Fork and Clone the Repository**:
   - **Fork the Repository**:
     - Visit the [TakeDeep GitHub repository](https://github.com/Quantum-General-Intelligence/Deepcode-vscode)
...
2. This will open a new VSCode window with TakeDeep loaded
...
TakeDeep uses several types of tests to ensure quality:
...
- Check the Output panel in VSCode (View > Output) and select "TakeDeep" from the dropdown
