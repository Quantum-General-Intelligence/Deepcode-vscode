...
# Using v0 With TakeDeep

TakeDeep supports v0, Vercel's AI model provider that offers an OpenAI-compatible API. This allows you to use v0's models with TakeDeep through the familiar OpenAI API interface.

## Prerequisites

To use v0 with TakeDeep, you'll need:
...
Setting up v0 in TakeDeep is straightforward:

1. In TakeDeep settings (click the {% codicon name="gear" /%} icon):
...
<!-- <img src="/docs/img/providers/v0-setup.png" alt="v0 configuration in TakeDeep settings" width="600" /> -->
