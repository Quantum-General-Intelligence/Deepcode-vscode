...
# Using Mistral AI With TakeDeep

TakeDeep supports accessing models through the Mistral AI API, including both standard Mistral models and the code-specialized Codestral model.
