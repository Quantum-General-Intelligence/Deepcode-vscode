---
title: "Automate"
description: "Automate your development workflows with TakeDeep"
---

# {% $markdoc.frontmatter.title %}

{% callout type="generic" %}
Automate repetitive tasks, set up AI-powered code reviews, and extend TakeDeep's capabilities with integrations and MCP servers.
{% /callout %}
...
Connect TakeDeep to external tools and services:
...
- [**Using MCP in TakeDeep**](/docs/automate/mcp/using-in-kilo-code) — Configuration guide
...
Connect TakeDeep with your development tools:
...
Customize and extend TakeDeep's capabilities:
