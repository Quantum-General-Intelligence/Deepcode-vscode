...
TakeDeep implements the Model Context Protocol to:
...
- [Using MCP in TakeDeep](using-in-kilo-code) - Get started with MCP in TakeDeep, including creating simple servers
