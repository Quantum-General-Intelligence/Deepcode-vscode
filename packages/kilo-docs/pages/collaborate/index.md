---
title: "Collaborate"
description: "Work together with TakeDeep team features"
---

# {% $markdoc.frontmatter.title %}

{% callout type="generic" %}
TakeDeep makes it easy to work together with your team. Share sessions, manage team settings, and track AI adoption across your organization.
{% /callout %}
...
- [**Sessions & Sharing**](/docs/collaborate/sessions-sharing) — Share and collaborate on TakeDeep sessions
...
TakeDeep's paid plans provide powerful team management features:
...
- **Enterprise ([Contact Sales](https://deeper-api.takedeep.ai/contact-sales))** — Model controls, audit logs, SSO, dedicated support
