---
title: "Dashboard"
description: "Manage your team from the TakeDeep dashboard"
---

# Dashboard

The Kilo seats dashboard is the first screen that comes up when you visit [the TakeDeep web app](https://deeper-dash.takedeep.ai). It provides complete visibility into your team's AI usage, costs, and management.
