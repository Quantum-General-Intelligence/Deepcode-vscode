export const dict = {
  ...
  "provider.connect.opencodeZen.line1":
    "TakeDeep Gateway даёт вам доступ к отобранным надёжным оптимизированным моделям для агентов программирования.",
  ...
  "settings.desktop.wsl.description": "Запускать сервер TakeDeep внутри WSL на Windows.",
  ...
  "settings.general.row.colorScheme.description": "Выберите, следует ли TakeDeep системной, светлой или тёмной теме",
