export const dict = {
  ...
  "provider.connect.opencodeZen.line1":
    "TakeDeep Gateway vous donne accès à un ensemble sélectionné de modèles fiables et optimisés pour les agents de codage.",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur TakeDeep dans WSL sur Windows.",
  ...
  "settings.general.row.colorScheme.description": "Choisissez si TakeDeep suit le thème système, clair ou sombre",
