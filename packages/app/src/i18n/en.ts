export const dict = {
  ...
  "sidebar.gettingStarted.line1": "TakeDeep includes free models so you can start immediately.",
  ...
  "settings.general.row.colorScheme.description": "Choose whether TakeDeep follows the system, light, or dark theme",
