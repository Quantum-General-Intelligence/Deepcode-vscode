export const dict = {
  ...
  "provider.connect.opencodeZen.line1":
    "TakeDeep Gateway은 코딩 에이전트를 위해 최적화된 신뢰할 수 있는 엄선된 모델에 대한 액세스를 제공합니다.",
  ...
  "dialog.plugins.empty": "kilo.jsonc에 구성된 플러그인",
  ...
  "error.chain.checkConfig": "구성(kilo.jsonc)의 공급자/모델 이름을 확인하세요",
  ...
  "settings.desktop.wsl.description": "Windows의 WSL 내부에서 TakeDeep 서버를 실행합니다.",
  ...
  "settings.general.row.colorScheme.description": "TakeDeep가 시스템, 라이트 또는 다크 테마를 따를지 선택하세요",
