export const dict = {
  ...
  "provider.connect.opencodeZen.line1":
    "TakeDeep Gateway giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  ...
  "settings.desktop.wsl.description": "Kør TakeDeep-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.colorScheme.description": "Vælg om TakeDeep følger systemets, lyst eller mørkt tema",
