export const dict = {
  ...
  "provider.connect.opencodeZen.line1":
    "TakeDeep Gateway oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor TakeDeep dentro do WSL no Windows.",
  ...
  "settings.general.row.colorScheme.description": "Escolha se o TakeDeep segue o tema do sistema, claro ou escuro",
