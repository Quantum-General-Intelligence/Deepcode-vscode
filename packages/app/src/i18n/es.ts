export const dict = {
  ...
  "provider.connect.opencodeZen.line1":
    "TakeDeep Gateway te da acceso a un conjunto curado de modelos fiables optimizados para agentes de programación.",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor TakeDeep dentro de WSL en Windows.",
  ...
  "settings.general.row.colorScheme.description": "Elige si TakeDeep sigue el tema del sistema, claro u oscuro",
