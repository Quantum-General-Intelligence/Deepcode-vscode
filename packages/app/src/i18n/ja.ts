export const dict = {
  ...
  "provider.connect.opencodeZen.line1":
    "TakeDeep Gatewayは、コーディングエージェント向けに最適化された信頼性の高いモデルへのアクセスを提供します。",
  ...
  "dialog.plugins.empty": "kilo.jsoncで設定されたプラグイン",
  ...
  "error.chain.checkConfig": "config (kilo.jsonc) のプロバイダー/モデル名を確認してください",
  ...
  "settings.desktop.wsl.description": "WindowsのWSL環境でTakeDeepサーバーを実行します。",
  ...
  "settings.general.row.colorScheme.description": "TakeDeepがシステム、ライト、またはダークテーマに従うかを選択します",
