...
export const dict = {
  ...
  "provider.connect.opencodeZen.line1":
    "TakeDeep Gateway bietet Ihnen Zugriff auf eine kuratierte Auswahl zuverlässiger, optimierter Modelle für Coding-Agenten.",
  ...
  "settings.desktop.wsl.description": "TakeDeep-Server innerhalb von WSL unter Windows ausführen.",
  ...
  "settings.general.row.colorScheme.description": "Wählen Sie, ob TakeDeep dem System-, hellen oder dunklen Thema folgt",
