export const dict = {
  ...
  "provider.connect.opencodeZen.line1":
    "TakeDeep Gateway ให้คุณเข้าถึงชุดโมเดลที่เชื่อถือได้และปรับแต่งแล้วสำหรับเอเจนต์การเขียนโค้ด",
  ...
  "dialog.plugins.empty": "ปลั๊กอินที่กำหนดค่าใน kilo.jsonc",
  ...
  "error.chain.checkConfig": "ตรวจสอบการกำหนดค่าของคุณ (kilo.jsonc) ชื่อผู้ให้บริการ/โมเดล",
  ...
  "settings.desktop.wsl.description": "เรียกใช้เซิร์ฟเวอร์ TakeDeep ภายใน WSL บน Windows",
  ...
  "settings.general.row.colorScheme.description": "เลือกว่าจะให้ TakeDeep ใช้ธีมตามระบบ สว่าง หรือมืด",
  ...
  "settings.updates.row.startup.description": "ตรวจสอบการอัปเดตโดยอัตโนมัติเมื่อ TakeDeep เปิดใช้งาน",
  ...
  "settings.updates.toast.latest.description": "คุณกำลังใช้งาน TakeDeep เวอร์ชันล่าสุด",
