...
export const dict = {
  ...
  "provider.connect.opencodeZen.line1":
    "TakeDeep Gateway, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  ...
  "toast.update.description": "TakeDeep'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "settings.desktop.wsl.description": "TakeDeep sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "TakeDeep'un görünüm dilini değiştirin",
  "settings.general.row.appearance.title": "Görünüm",
  "settings.general.row.appearance.description": "TakeDeep'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description": "TakeDeep'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "TakeDeep'un temasını özelleştirin.",
  ...
  "settings.updates.toast.latest.description": "TakeDeep'un en son sürümünü kullanıyorsunuz.",
