export const dict = {
  ...
  "provider.connect.opencodeZen.line1":
    "TakeDeep Gateway daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodujących.",
  ...
  "settings.desktop.wsl.description": "Run the TakeDeep server inside WSL on Windows.",
  ...
  "settings.general.row.colorScheme.description":
    "Wybierz, czy TakeDeep ma używać motywu systemowego, jasnego czy ciemnego",
