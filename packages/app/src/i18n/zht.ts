...
export const dict = {
  ...
  "provider.connect.opencodeZen.line1": "TakeDeep Gateway 為你提供一組精選的可靠最佳化模型，用於程式碼代理程式。",
  ...
  "settings.desktop.wsl.description": "在 Windows 上的 WSL 中執行 TakeDeep 伺服器。",
  ...
  "settings.general.row.colorScheme.description": "選擇 TakeDeep 要跟隨系統、淺色或深色主題",
