export const dict = {
  ...
  "provider.connect.opencodeZen.line1":
    "TakeDeep Gateway ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  ...
  "error.chain.checkConfig": "Provjeri konfiguraciju (kilo.jsonc) provider/model names",
  ...
  "settings.desktop.wsl.description": "Pokreni TakeDeep server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.colorScheme.description": "Odaberi da li TakeDeep prati sistemsku, svijetlu ili tamnu temu",
