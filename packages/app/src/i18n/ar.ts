export const dict = {
  ...
  "provider.connect.opencodeZen.line1":
    "يمنحك TakeDeep Gateway الوصول إلى مجموعة مختارة من النماذج الموثوقة والمحسنة لوكلاء البرمجة.",
  ...
  "settings.desktop.wsl.description": "تشغيل خادم TakeDeep داخل WSL على Windows.",
  ...
  "settings.general.row.colorScheme.description": "اختر ما إذا كان TakeDeep يتبع سمة النظام أو الفاتح أو الداكن",
