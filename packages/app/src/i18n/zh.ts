...
export const dict = {
  ...
  "provider.connect.opencodeZen.line1": "TakeDeep Gateway 为你提供一组精选的可靠优化模型，用于代码智能体。",
  ...
  "dialog.plugins.empty": "在 kilo.jsonc 中配置的插件",
  ...
  "error.chain.checkConfig": "请检查你的配置 (kilo.jsonc) 中的 provider/model 名称",
  ...
  "settings.desktop.wsl.description": "在 Windows 的 WSL 环境中运行 TakeDeep 服务器。",
  ...
  "settings.general.row.colorScheme.description": "选择 TakeDeep 跟随系统、浅色或深色主题",
