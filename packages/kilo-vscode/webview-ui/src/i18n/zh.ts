...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "TakeDeep 提供的免费模型",
  ...
  "provider.connect.apiKey.description":
    "输入你的 {{provider}} API 密钥以连接帐户，并在 TakeDeep 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.code.visit.suffix": " 获取授权码，以连接你的帐户并在 TakeDeep 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix": " 并输入以下代码，以连接你的帐户并在 TakeDeep 中使用 {{provider}} 模型。",
  ...
  "dialog.server.description": "切换此应用连接的 TakeDeep 服务器。",
  ...
  "toast.update.description": "TakeDeep 有新版本 ({{version}}) 可安装。",
  ...
  "error.page.report.prefix": "请将此错误报告给 TakeDeep 团队",
  ...
  "error.chain.mcpFailed": 'MCP 服务器 "{{name}}" 启动失败。注意: TakeDeep 暂不支持 MCP 认证。',
  ...
  "sidebar.gettingStarted.line1": "TakeDeep 提供免费模型，你可以立即开始使用。",
  ...
  "settings.general.row.language.description": "更改 TakeDeep 的显示语言",
  "settings.general.row.appearance.title": "外观",
  "settings.general.row.appearance.description": "自定义 TakeDeep 在你的设备上的外观",
  "settings.general.row.theme.title": "主题",
  "settings.general.row.theme.description": "自定义 TakeDeep 的主题。",
  ...
  "settings.updates.row.startup.description": "在 TakeDeep 启动时自动检查更新",
  ...
  "settings.providers.betaNotice":
    "目前只能在设置界面中配置 TakeDeep Gateway 提供商。在 Beta 测试期间即将支持配置其他提供商。在此期间，您可以使用 CLI 或配置文件来配置提供商。我们致力于保持 TakeDeep 开放，无锁定。",
  ...
  "settings.config.title": "打开 {{scope}} TakeDeep 配置文件",
  "settings.config.placeholder": "配置文件按顺序合并；标记为已加载的文件目前会影响设置。",
  "settings.config.noWorkspace": "打开工作区文件夹以编辑本地 TakeDeep 配置文件。",
  "settings.config.openFailed": "无法打开 {{scope}} TakeDeep 配置文件：{{message}}",
  "settings.config.source.xdg": "XDG 全局配置",
  "settings.config.source.homeKilo": "主目录 .takedeep 配置",
  ...
  "settings.config.source.projectKilo": "项目 .takedeep 配置",
  ...
  "profile.action.login": "使用 TakeDeep 登录",
  ...
  "settings.aboutKiloCode.title": "关于 TakeDeep",

  "session.messages.empty": "在下方输入消息以开始对话。",
  "session.messages.welcome": "TakeDeep 是一个 AI 编程助手。让它帮你构建功能、修复 bug 或解释代码库。",
  ...
  "settings.aboutKiloCode.extensionName": "TakeDeep 扩展",
  ...
  "settings.aboutKiloCode.importSettings.invalidConfig": "文件不包含有效的 TakeDeep 设置。",
  "settings.aboutKiloCode.importSettings.tooLarge": "文件过大。设置文件必须小于 1 MB。",
  "settings.aboutKiloCode.importSettings.newerVersion": "此文件由较新版本的 TakeDeep 导出。部分设置可能会被忽略。",
  ...
  "settings.language.description": '"自动"将使用 VS Code 的显示语言。选择 TakeDeep 界面的语言。',
  ...
  "settings.experimental.remote.description": "通过 TakeDeep Cloud 启用会话的 Remote 控制。这也会影响此计算机上的 CLI。",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "将 Claude Code 配置目录中的 CLAUDE.md 指令和技能加载到会话中。如果您希望 TakeDeep 使用您的 Claude Code 指令和技能，请启用此选项。需要重启。",
  ...
  "settings.aboutKiloCode.legacyMigration.description":
    "从旧版 TakeDeep 安装迁移设置，包括提供商 API 密钥和默认模型。",
  ...
  "migration.whatsNew.features.foundation.detail":
    "所有 TakeDeep 产品共享一个小巧高效的核心。无论你选择哪种方式工作，都能获得熟悉的体验。",
