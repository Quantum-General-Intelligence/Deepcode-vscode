export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por TakeDeep",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en TakeDeep.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en TakeDeep.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en TakeDeep.",
  ...
  "dialog.server.description": "Cambiar a qué servidor de TakeDeep se conecta esta app.",
  ...
  "toast.update.description": "Una nueva versión de TakeDeep ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Por favor reporta este error al equipo de TakeDeep",
  ...
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota, TakeDeep no soporta autenticación MCP todavía.',
  ...
  "sidebar.gettingStarted.line1": "TakeDeep incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para TakeDeep",
  "settings.general.row.appearance.title": "Apariencia",
  "settings.general.row.appearance.description": "Personaliza cómo se ve TakeDeep en tu dispositivo",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de TakeDeep.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia TakeDeep",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de TakeDeep.",
  ...
  "settings.providers.betaNotice":
    "Actualmente, solo el proveedor TakeDeep Gateway se puede configurar en la interfaz de ajustes. El soporte para configurar otros proveedores llegará pronto durante el período beta. Mientras tanto, puedes configurar proveedores usando la CLI o el archivo de configuración. Estamos comprometidos a mantener TakeDeep abierto, sin ataduras.",
  ...
  "settings.config.title": "Abrir archivo de configuración TakeDeep {{scope}}",
  ...
  "settings.config.noWorkspace":
    "Abre una carpeta de espacio de trabajo para editar el archivo de configuración TakeDeep local.",
  "settings.config.openFailed": "Error al abrir el archivo de configuración TakeDeep {{scope}}: {{message}}",
  "settings.config.source.xdg": "Configuración global XDG",
  "settings.config.source.homeKilo": "Configuración .takedeep de Home",
  ...
  "settings.config.source.projectKilo": "Configuración .takedeep del proyecto",
  ...
  "deviceAuth.title": "Iniciar sesión en TakeDeep",
  ...
  "profile.action.login": "Iniciar sesión con TakeDeep",
  ...
  "settings.aboutKiloCode.title": "Acerca de TakeDeep",

  "session.messages.empty": "Inicia una conversación escribiendo un mensaje a continuación.",
  "session.messages.welcome":
    "TakeDeep es un asistente de programación con IA. Pídele que cree funcionalidades, corrija errores o explique tu código.",
  ...
  "settings.aboutKiloCode.extensionName": "Extensión TakeDeep",
  ...
  "settings.aboutKiloCode.importSettings.invalidConfig": "El archivo no contiene ajustes válidos de TakeDeep.",
  ...
  "settings.aboutKiloCode.importSettings.newerVersion":
    "Este archivo fue exportado desde una versión más reciente de TakeDeep. Algunos ajustes podrían ignorarse.",
  ...
  "settings.language.description":
    'Elige el idioma de la interfaz de TakeDeep. "Auto" utiliza el idioma de visualización de VS Code.',
  ...
  "settings.experimental.remote.description":
    "Habilite el control Remote de las sesiones a través de TakeDeep Cloud. Esto también afectará a las CLI de este equipo.",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "Carga las instrucciones y habilidades de CLAUDE.md desde tu directorio de configuración de Claude Code en las sesiones. Activa esta opción si quieres que TakeDeep utilice tus instrucciones y habilidades de Claude Code. Requiere reiniciar.",
  ...
  "settings.aboutKiloCode.legacyMigration.description":
    "Migra la configuración de una instalación anterior de TakeDeep, incluyendo las claves API de proveedores y el modelo predeterminado.",

  // Screen 1 — What's New
  "migration.whatsNew.title": "Novedades en TakeDeep",
  ...
  "migration.whatsNew.features.foundation.detail":
    "Un núcleo pequeño y eficiente en todos los productos TakeDeep. Una experiencia familiar sin importar cómo elijas trabajar.",
