...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "TakeDeep 提供的免費模型",
  ...
  "provider.connect.apiKey.description":
    "輸入你的 {{provider}} API 金鑰以連線帳戶，並在 TakeDeep 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.code.visit.suffix": " 取得授權碼，以連線你的帳戶並在 TakeDeep 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix": " 並輸入以下程式碼，以連線你的帳戶並在 TakeDeep 中使用 {{provider}} 模型。",
  ...
  "dialog.server.description": "切換此應用程式連線的 TakeDeep 伺服器。",
  ...
  "toast.update.description": "TakeDeep 有新版本 ({{version}}) 可安裝。",
  ...
  "error.page.report.prefix": "請將此錯誤回報給 TakeDeep 團隊",
  ...
  "error.chain.mcpFailed": 'MCP 伺服器 "{{name}}" 啟動失敗。注意：TakeDeep 暫不支援 MCP 認證。',
  ...
  "sidebar.gettingStarted.line1": "TakeDeep 提供免費模型，你可以立即開始使用。",
  ...
  "settings.general.row.language.description": "變更 TakeDeep 的顯示語言",
  "settings.general.row.appearance.title": "外觀",
  "settings.general.row.appearance.description": "自訂 TakeDeep 在你的裝置上的外觀",
  "settings.general.row.theme.title": "主題",
  "settings.general.row.theme.description": "自訂 TakeDeep 的主題。",
  ...
  "settings.updates.row.startup.description": "在 TakeDeep 啟動時自動檢查更新",
  ...
  "settings.updates.toast.latest.description": "你正在使用最新版本的 TakeDeep。",
  ...
  "settings.providers.betaNotice":
    "目前在設定介面中僅能配置 TakeDeep Gateway 供應商。在測試期間，即將推出配置其他供應商的支援。在此期間，您可以使用 CLI 或設定檔來配置供應商。我們致力於保持 TakeDeep 開放，絕不綁定。",
  ...
  "settings.config.title": "開啟 {{scope}} TakeDeep 設定檔",
  "settings.config.placeholder": "設定檔會按順序合併；標記為已載入的檔案目前會影響設定。",
  "settings.config.noWorkspace": "開啟工作區資料夾以編輯本地 TakeDeep 設定檔。",
  "settings.config.openFailed": "無法開啟 {{scope}} TakeDeep 設定檔：{{message}}",
  "settings.config.source.xdg": "XDG 全域設定",
  "settings.config.source.homeKilo": "主目錄 .takedeep 設定",
  ...
  "settings.config.source.projectKilo": "專案 .takedeep 設定",
  ...
  "profile.action.login": "使用 TakeDeep 登入",
  ...
  "settings.aboutKiloCode.title": "關於 TakeDeep",

  "session.messages.empty": "在下方輸入訊息以開始對話。",
  "session.messages.welcome": "TakeDeep 是一個 AI 程式設計助手。讓它幫你建構功能、修復 bug 或解釋程式碼庫。",
  ...
  "settings.aboutKiloCode.extensionName": "TakeDeep 擴充功能",
  ...
  "settings.aboutKiloCode.importSettings.invalidConfig": "檔案不包含有效的 TakeDeep 設定。",
  "settings.aboutKiloCode.importSettings.tooLarge": "檔案過大。設定檔必須小於 1 MB。",
  "settings.aboutKiloCode.importSettings.newerVersion": "此檔案由較新版本的 TakeDeep 匯出。部分設定可能會被忽略。",
  ...
  "settings.language.description": "選擇 TakeDeep 介面的語言。「自動」使用 VS Code 的顯示語言。",
  ...
  "settings.experimental.remote.description": "透過 TakeDeep Cloud 啟用工作階段的 Remote 控制。這也會影響此電腦上的 CLI。",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "從您的 Claude Code 設定目錄將 CLAUDE.md 指示與技能載入至工作階段中。如果您希望 TakeDeep 使用您的 Claude Code 指示與技能，請啟用此選項。需要重新啟動。",
  ...
  "settings.aboutKiloCode.legacyMigration.description":
    "從舊版 TakeDeep 安裝遷移設定，包括供應商 API 金鑰和預設模型。",

  // Screen 1 — What's New
  "migration.whatsNew.title": "TakeDeep 新功能",
  ...
  "migration.whatsNew.features.foundation.detail":
    "所有 TakeDeep 產品共享一個小巧高效的核心。無論你選擇哪種方式工作，都能獲得熟悉的體驗。",
