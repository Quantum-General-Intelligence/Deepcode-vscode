...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von TakeDeep",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren {{provider}} API-Schlüssel ein, um Ihr Konto zu verbinden und {{provider}} Modelle in TakeDeep zu nutzen.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}} Modelle in TakeDeep zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}} Modelle in TakeDeep zu nutzen.",
  ...
  "dialog.server.description": "Wechseln Sie den TakeDeep-Server, mit dem sich diese App verbindet.",
  ...
  "toast.update.description": "Eine neue Version von TakeDeep ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem TakeDeep-Team",
  ...
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: TakeDeep unterstützt noch keine MCP-Authentifizierung.',
  ...
  "sidebar.gettingStarted.line1": "TakeDeep enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für TakeDeep ändern",
  "settings.general.row.appearance.title": "Erscheinungsbild",
  "settings.general.row.appearance.description": "Anpassen, wie TakeDeep auf Ihrem Gerät aussieht",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von TakeDeep anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von TakeDeep automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.description": "Du verwendest die aktuelle Version von TakeDeep.",
  ...
  "settings.config.title": "{{scope}} TakeDeep-Konfigurationsdatei öffnen",
  ...
  "settings.config.noWorkspace":
    "Öffnen Sie einen Arbeitsbereichsordner, um die lokale TakeDeep-Konfigurationsdatei zu bearbeiten.",
  "settings.config.openFailed": "Fehler beim Öffnen der {{scope}} TakeDeep-Konfigurationsdatei: {{message}}",
  "settings.config.source.xdg": "Globale XDG-Konfiguration",
  "settings.config.source.homeKilo": "Home .takedeep-Konfiguration",
  "settings.config.source.homeKilocode": "Home .takedeepcode-Konfiguration",
  ...
  "settings.config.source.projectKilo": "Projekt .takedeep-Konfiguration",
  ...
  "deviceAuth.title": "Bei TakeDeep anmelden",
  ...
  "profile.action.login": "Mit TakeDeep anmelden",
  ...
  "settings.aboutKiloCode.title": "Über TakeDeep",

  "session.messages.empty": "Starten Sie eine Unterhaltung, indem Sie unten eine Nachricht eingeben.",
  "session.messages.welcome":
    "TakeDeep ist ein KI-Programmierassistent. Bitten Sie ihn, Funktionen zu erstellen, Fehler zu beheben oder Ihre Codebasis zu erklären.",
  ...
  "settings.aboutKiloCode.extensionName": "TakeDeep Erweiterung",
  ...
  "settings.aboutKiloCode.importSettings.invalidConfig": "Die Datei enthält keine gültigen TakeDeep-Einstellungen.",
  ...
  "settings.aboutKiloCode.importSettings.newerVersion":
    "Diese Datei wurde mit einer neueren Version von TakeDeep exportiert. Einige Einstellungen werden möglicherweise ignoriert.",
  ...
  "settings.language.description":
    'Wählen Sie die Sprache für die TakeDeep Oberfläche. „Auto" verwendet die VS Code Anzeigesprache.',
  ...
  "settings.experimental.remote.description":
    "Aktivieren Sie die Remote-Steuerung von Sitzungen über TakeDeep Cloud. Dies betrifft auch CLIs auf diesem Computer.",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "Lädt CLAUDE.md-Anweisungen und Skills aus Ihrem Claude Code-Konfigurationsverzeichnis in Sitzungen. Aktivieren Sie dies, wenn TakeDeep Ihre Claude Code-Anweisungen und Skills verwenden soll. Neustart erforderlich.",
  ...
  "settings.aboutKiloCode.legacyMigration.description":
    "Migrieren Sie Einstellungen von einer früheren Installation von TakeDeep, einschließlich Anbieter-API-Schlüsseln und dem Standardmodell.",

  // Screen 1 — What's New
  "migration.whatsNew.title": "Neuigkeiten in TakeDeep",
  ...
  "migration.whatsNew.features.foundation.detail":
    "Ein kleiner, effizienter Kern über alle TakeDeep-Produkte hinweg. Ein vertrautes Erlebnis, egal wie Sie arbeiten.",
