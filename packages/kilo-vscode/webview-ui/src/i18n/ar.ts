export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "نماذج مجانية مقدمة من TakeDeep",
  ...
  "provider.connect.apiKey.description":
    "أدخل مفتاح واجهة برمجة تطبيقات {{provider}} الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في TakeDeep.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " للحصول على رمز التفويض الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في TakeDeep.",
  ...
  "provider.connect.oauth.auto.visit.suffix": " وأدخل الرمز أدناه لتوصيل حسابك واستخدام نماذج {{provider}} في TakeDeep.",
  ...
  "dialog.server.description": "تبديل خادم TakeDeep الذي يتصل به هذا التطبيق.",
  ...
  "toast.update.description": "نسخة جديدة من TakeDeep ({{version}}) متاحة الآن للتثبيت.",
  ...
  "error.page.report.prefix": "يرجى الإبلاغ عن هذا الخطأ لفريق TakeDeep",
  ...
  "error.chain.mcpFailed": 'فشل خادم MCP "{{name}}". لاحظ أن TakeDeep لا يدعم مصادقة MCP بعد.',
  ...
  "sidebar.gettingStarted.line1": "يتضمن TakeDeep نماذج مجانية حتى تتمكن من البدء فورًا.",
  ...
  "settings.general.row.language.description": "تغيير لغة العرض لـ TakeDeep",
  "settings.general.row.appearance.title": "المظهر",
  "settings.general.row.appearance.description": "تخصيص كيفية ظهور TakeDeep على جهازك",
  "settings.general.row.theme.title": "السمة",
  "settings.general.row.theme.description": "تخصيص سمة TakeDeep.",
  ...
  "settings.updates.row.startup.description": "التحقق تلقائيًا من التحديثات عند تشغيل TakeDeep",
  ...
  "settings.updates.toast.latest.description": "أنت تستخدم أحدث إصدار من TakeDeep.",
  ...
  "settings.providers.betaNotice":
    "حالياً، يمكن إعداد مزود TakeDeep Gateway فقط في واجهة الإعدادات. سيتوفر دعم إعداد المزودين الآخرين قريباً خلال الفترة التجريبية. في غضون ذلك، يمكنك إعداد المزودين باستخدام CLI أو ملف التكوين. نحن ملتزمون بإبقاء TakeDeep مفتوحاً، دون تقييد.",
  ...
  "settings.config.title": "فتح ملف تكوين TakeDeep {{scope}}",
  "settings.config.placeholder": "يتم دمج ملفات التكوين بالترتيب؛ الملفات المحددة كمحملة تؤثر حاليًا على الإعدادات.",
  "settings.config.noWorkspace": "افتح مجلد مساحة عمل لتحرير ملف تكوين TakeDeep المحلي.",
  "settings.config.openFailed": "فشل فتح ملف تكوين TakeDeep {{scope}}: {{message}}",
  "settings.config.source.xdg": "تكوين XDG العالمي",
  "settings.config.source.homeKilo": "تكوين .takedeep في Home",
  ...
  "settings.config.source.projectKilo": "تكوين .takedeep للمشروع",
  ...
  "deviceAuth.title": "تسجيل الدخول إلى TakeDeep",
  ...
  "profile.action.login": "تسجيل الدخول باستخدام TakeDeep",
  ...
  "settings.aboutKiloCode.title": "حول TakeDeep",

  "session.messages.empty": "ابدأ محادثة بكتابة رسالة أدناه.",
  "session.messages.welcome":
    "TakeDeep هو مساعد ترميز بالذكاء الاصطناعي. اطلب منه بناء ميزات أو إصلاح أخطاء أو شرح قاعدة الشيفرة.",
  ...
  "settings.aboutKiloCode.extensionName": "إضافة TakeDeep",
  ...
  "settings.aboutKiloCode.importSettings.invalidConfig": "الملف لا يحتوي على إعدادات TakeDeep صالحة.",
  "settings.aboutKiloCode.importSettings.tooLarge": "الملف كبير جدًا. يجب أن تكون ملفات الإعدادات أقل من 1 MB.",
  "settings.aboutKiloCode.importSettings.newerVersion":
    "تم تصدير هذا الملف من إصدار أحدث من TakeDeep. قد يتم تجاهل بعض الإعدادات.",
  ...
  "settings.language.description": 'اختر اللغة لواجهة TakeDeep. "تلقائي" يستخدم لغة عرض VS Code.',
  ...
  "settings.experimental.remote.description":
    "قم بتمكين التحكم Remote في الجلسات عبر TakeDeep Cloud. سيؤثر هذا أيضًا على واجهات سطر الأوامر (CLIs) على هذا الجهاز.",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "تحميل تعليمات ومهارات CLAUDE.md من مجلد إعدادات Claude Code إلى الجلسات. قم بتمكين هذا الخيار إذا كنت ترغب في أن يستخدم TakeDeep مهارات وتعليمات Claude Code الخاصة بك. يتطلب إعادة التشغيل.",
  ...
  "settings.aboutKiloCode.legacyMigration.description":
    "ترحيل الإعدادات من تثبيت سابق لـ TakeDeep، بما في ذلك مفاتيح API لمقدمي الخدمة والنموذج الافتراضي.",

  // Screen 1 — What's New
  "migration.whatsNew.title": "ما الجديد في TakeDeep",
  ...
  "migration.whatsNew.features.foundation.detail":
    "نواة صغيرة وفعالة واحدة عبر كل منتجات TakeDeep. تجربة مألوفة بغض النظر عن طريقة عملك.",
