...
export function registerCodeActions(
  ...
  context.subscriptions.push(
    vscode.commands.registerCommand("takedeep.explainCode", () => {
    ...
    vscode.commands.registerCommand("takedeep.fixCode", () => {
      const ctx = getEditorContext()
      if (!ctx) return
    ...
    vscode.commands.registerCommand("takedeep.improveCode", () => {
      const ctx = getEditorContext()
      if (!ctx) return
    ...
    vscode.commands.registerCommand("takedeep.addToContext", () => {
      const ctx = getEditorContext()
      if (!ctx) return
    ...
    vscode.commands.registerCommand("takedeep.focusChatInput", () => {
