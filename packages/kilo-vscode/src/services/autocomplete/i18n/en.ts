...
export const dict = {
  ...
  "kilocode:autocomplete.statusBar.tooltip.basic": "TakeDeep Autocomplete",
  "kilocode:autocomplete.statusBar.tooltip.disabled": "TakeDeep Autocomplete (disabled)",
  ...
  "kilocode:autocomplete.toggleMessage": "TakeDeep Autocomplete {{status}}",
  "kilocode:autocomplete.progress.title": "TakeDeep",
  ...
  "kilocode:autocomplete.input.title": "TakeDeep: Quick Task",
  "kilocode:autocomplete.input.placeholder": "e.g., 'refactor this function to be more efficient'",
  "kilocode:autocomplete.commands.generateSuggestions": "TakeDeep: Generate Suggested Edits",
  ...
  "kilocode:autocomplete.commands.category": "TakeDeep",
  "kilocode:autocomplete.codeAction.title": "TakeDeep: Suggested Edits",
  "kilocode:autocomplete.chatParticipant.fullName": "TakeDeep Agent",
