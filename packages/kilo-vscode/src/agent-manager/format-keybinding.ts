...
const AM_PREFIX = "takedeep.agentManager."

/** Global commands whose keybindings are forwarded to the webview. */
const GLOBAL_KEYBINDINGS: Record<string, string> = {
  "takedeep.agentManagerOpen": "agentManagerOpen",
  "takedeep.cycleAgentMode": "cycleAgentMode",
  "takedeep.cyclePreviousAgentMode": "cyclePreviousAgentMode",
}
