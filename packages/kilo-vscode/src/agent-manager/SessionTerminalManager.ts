...
export class SessionTerminalManager {
  ...
  constructor(
    ...
    this.disposables.push(
      ...
      host.onActiveTerminalChanged((terminal) => {
        ...
        void host.setContext("takedeep.agentTerminalFocus", managed)
      }),
    )
  ...
  dispose(): void {
    void this.host.setContext("takedeep.agentTerminalFocus", false)
  ...
  private updateContextKey(): void {
    ...
    void this.host.setContext("takedeep.agentTerminalFocus", managed)
  }
