...
describe("installation", () => {
  describe("latest", () => {
    ...
    test("reads npm versions via npm view", async () => {
      ...
      expect(calls).toContainEqual(["npm", "view", `@takedeep/cli@${InstallationChannel}`, "version", "--json"]) // kilocode_change
    })
    ...
    test("reads npm versions via bun pm view", async () => {
      ...
      expect(calls).toContainEqual(["bun", "pm", "view", `@takedeep/cli@${InstallationChannel}`, "version", "--json"]) // kilocode_change
    })
    ...
    test("reads npm versions via pnpm view", async () => {
      ...
      expect(calls).toContainEqual(["pnpm", "view", `@takedeep/cli@${InstallationChannel}`, "version", "--json"]) // kilocode_change
    })
