...
export const BRAND = {
  ...
  configSchemaUrl: "https://deeper-api.takedeep.ai/config.json",
  shareUrl: "https://deeper-dash.takedeep.ai/s",
  feedbackUrl: "https://deeper-api.takedeep.ai/feedback",
  changelogUrl: "https://deeper-api.takedeep.ai/changelog.json",
  faviconUrl: "https://deeper.takedeep.ai/favicon.svg",
